...
The model’s performance was evaluated using standard multilabel classification metrics, including precision, recall, F1-score, and accuracy. Each crime type was treated as an independent binary classification task, and metrics were computed separately before averaging across all labels to obtain macro-level results. This ensured that each crime type contributed equally to the evaluation, regardless of how often it occurred.
...
\begin{figure}[h!]
    ...
    \caption{Training and validation loss curves for model performance.}
    \label{fig:image1}
\end{figure}
...
\begin{figure}[h!]
    ...
    \caption{Comparison of model performance under different regularization techniques.}
    \label{fig:image2}
\end{figure}

\begin{figure}[h!]
    \centering
    \includegraphics[width=1.3\linewidth]{images/image3.png}
...
Alina: defined what the training dataset would look like; programmed the sections for data preprocessing and feature engineering; wrote the report sections for dataset, features, and related work with references.

Stanley: implemented the evaluation pipeline and L1/L2 experiments; wrote the Results and Evaluation section and integrated the visualizations into the report.
% ====================================================================================================
